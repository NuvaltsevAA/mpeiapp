...
class ScheduleParser {
    private val coupleBuilder =
        CoupleBuilder()
    private val scheduleBuilder =
        ScheduleBuilder()
    ...
    private fun parseTr(matchResult: MatchResult) {
        ...
        when {
            ...
            group.matches(DAY_INFO) -> DAY_INFO
                ...
                .value
                .let { pushDayInfo(it) }
            group.matches(COUPLE_INFO) -> pushCoupleInfo(
                COUPLE_INFO.findGroupsIn(group))
        }
    }
